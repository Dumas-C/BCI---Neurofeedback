...
namespace THOR
{
    ...
    public class THOR_ThunderstormEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            if (EditorGUIUtility.isProSkin) bgTex = AssetDatabase.LoadAssetAtPath(inspectorGUIPath + "/THOR_bgTex_DarkSkin.jpg", typeof(Texture2D)) as Texture2D;
            else bgTex = AssetDatabase.LoadAssetAtPath(inspectorGUIPath + "/THOR_bgTex_LightSkin.jpg", typeof(Texture2D)) as Texture2D;
        ...
        public override void OnInspectorGUI()
        {
            ...
            Rect bgRect = EditorGUILayout.GetControlRect(GUILayout.Width(0), GUILayout.Height(56));
            bgRect = new Rect(bgRect.x + 34, bgRect.y - 18, currentViewWidth - 87, bgRect.height + 1);
